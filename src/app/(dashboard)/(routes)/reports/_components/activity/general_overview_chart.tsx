...
type Props = {
	...
	total_incompleted_responses: number;
	average_completion_rate: number;
};

const ActivityGeneralOverviewChart: React.FC<Props> = (props) => {
	const data02 = [
		{
			name: "Completed Responses",
			value: props.total_completed_responses,
		},
		{
			name: "Incompleted Responses",
			value: props.total_incompleted_responses,
		},
	];
...
export default ActivityGeneralOverviewChart;
