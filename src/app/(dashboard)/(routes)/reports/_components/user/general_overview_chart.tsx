...
const UsersGeneralOverviewChart: React.FC<Props> = (props) => {
	const data02 = [
		{
			name: "Active Users",
			value: props.total_active_users,
		},
		{
			name: "Inactive Users",
			value: props.total_inactive_users,
		},
	];
		...
		<div className="mt-1 flex gap-6">
			...
			<div className="flex flex-col items-center justify-center">
				<div className="inline-flex items-center gap-4 text-xs">
					...
					<span className="text-nowrap">Total Active Users</span>
				...
				<div className="mt-8 inline-flex items-center gap-2 text-xs">
					...
					<span className="text-nowrap">Total Inactive Users</span>
					<span className="flex items-center">
...
export default UsersGeneralOverviewChart;
