...
const EditSesSurveyForm = () => {
	...
	const { mutate, isPending: isPendingMutation } = useMutation({
		mutationKey: ["edit survey ses score"],
		mutationFn: (data: UpdateSesScoreRequest) =>
			surveyService.updateSesScore(data, token || ""),
	...
	return (
		...
		>
			<Card className="pb-8 transition-all duration-500">
				<CardHeader>
					<CardTitle>
						Update SES Scores of {data?.data?.name || "Survey"}{" "}
					</CardTitle>
					<CardDescription>
...
export default EditSesSurveyForm;
