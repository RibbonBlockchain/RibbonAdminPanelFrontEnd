	...
	return (
		<DayPicker
			...
			classNames={{
				...
				caption_label: "text-sm font-medium border",
				...
				day_selected:
					"bg-neutral-300 text-white hover:bg-neutral-900 hover:text-white focus:bg-neutral-900 focus:text-white dark:bg-neutral-50 dark:text-white dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-white",
				day_today:
